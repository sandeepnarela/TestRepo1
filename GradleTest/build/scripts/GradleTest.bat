...
set CLASSPATH=%APP_HOME%\lib\GradleTest.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar;%APP_HOME%\lib\guava-21.0.jar

@rem Execute GradleTest
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLE_TEST_OPTS%  -classpath "%CLASSPATH%" com.capgemini.HelloWord %CMD_LINE_ARGS%
